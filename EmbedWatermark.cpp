...
void embed(double ***hsi, double ***watermarkHsi, Mat image, Mat watermark);
...
int main(int argc, char** argv )
{
    ...
    //embed image
    embed(hsi, watermarkHsi, image, watermark);
...
void embed(double ***hsi, double ***watermarkHsi, Mat image, Mat watermark)
{
    ...
    // double ***tempHsi = initialize_hsi(image);
    // double max = 0;
    // for(int x=0; x < watermark.rows;x++)
    // {
    //     for(int y=0; y < watermark.cols;y++)
    //     {
    //         tempHsi[x*10][y*10][2] = watermarkHsi[x][y][2];
    //     }
    // }
